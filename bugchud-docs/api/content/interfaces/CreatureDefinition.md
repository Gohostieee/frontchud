...
Defined in: [content/gm.ts:14](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L14)
...
| <a id="property-id"></a> `id` | [`CreatureId`](../../foundation/type-aliases/CreatureId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/gm.ts:15](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L15) |
| <a id="property-species"></a> `species` | `string` | - | - | [content/gm.ts:16](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L16) |
| <a id="property-challenge"></a> `challenge` | `number` | - | - | [content/gm.ts:17](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L17) |
| <a id="property-combattemplate"></a> `combatTemplate` | [`CombatantProfileTemplate`](CombatantProfileTemplate.md) | - | - | [content/gm.ts:18](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L18) |
| <a id="property-defaultmutationrefs"></a> `defaultMutationRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"mutation"`\>[] | - | - | [content/gm.ts:19](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L19) |
| <a id="property-defaultspellrefs"></a> `defaultSpellRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"spell"`\>[] | - | - | [content/gm.ts:20](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L20) |
| <a id="property-defaultloadout"></a> `defaultLoadout?` | readonly [`OwnershipGrant`](OwnershipGrant.md)[] | - | - | [content/gm.ts:21](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L21) |
| <a id="property-moraleprofile"></a> `moraleProfile?` | `object` | - | - | [content/gm.ts:22](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L22) |
| `moraleProfile.discipline` | `number` | - | - | [content/gm.ts:23](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L23) |
| `moraleProfile.breakThreshold` | `number` | - | - | [content/gm.ts:24](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/gm.ts#L24) |
...
| <a id="property-kind"></a> `kind` | `"creature"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
