...
Defined in: [content/character.ts:54](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L54)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-id"></a> `id` | [`DreamId`](../../foundation/type-aliases/DreamId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/character.ts:55](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L55) |
| <a id="property-group"></a> `group` | \| `"arcane"` \| `"pseudoCivilized"` \| `"barbaric"` \| `"darklands"` \| `"attribute"` \| `"faith"` \| `"alchemy"` \| `"leadership"` | - | - | [content/character.ts:56](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L56) |
| <a id="property-tier"></a> `tier` | `1` \| `2` \| `3` \| `4` | - | - | [content/character.ts:57](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L57) |
| <a id="property-fatecost"></a> `fateCost` | `number` | - | - | [content/character.ts:58](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L58) |
| <a id="property-repeatable"></a> `repeatable?` | `boolean` | - | - | [content/character.ts:59](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L59) |
| <a id="property-prerequisitedreamrefs"></a> `prerequisiteDreamRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"dream"`\>[] | - | - | [content/character.ts:60](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L60) |
| <a id="property-grants"></a> `grants` | readonly [`GrantedCapability`](../type-aliases/GrantedCapability.md)[] | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`grants`](BaseTaggedDefinition.md#property-grants) | - | [content/character.ts:61](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L61) |
...
| <a id="property-kind"></a> `kind` | `"dream"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
