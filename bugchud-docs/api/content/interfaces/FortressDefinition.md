...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / FortressDefinition

# Interface: FortressDefinition

Defined in: [content/world.ts:77](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L77)

Fortress/stronghold definition for campaign-scale play.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"fortress"`\>
...
| <a id="property-id"></a> `id` | [`FortressId`](../../foundation/type-aliases/FortressId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/world.ts:78](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L78) |
| <a id="property-tier"></a> `tier` | `1` \| `2` \| `3` \| `4` \| `5` | - | - | [content/world.ts:79](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L79) |
| <a id="property-regionref"></a> `regionRef?` | [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"region"`\> | - | - | [content/world.ts:80](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L80) |
| <a id="property-defenserating"></a> `defenseRating` | `number` | - | - | [content/world.ts:81](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L81) |
| <a id="property-supplycapacity"></a> `supplyCapacity` | `number` | - | - | [content/world.ts:82](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L82) |
| <a id="property-garrisoncapacity"></a> `garrisonCapacity` | `number` | - | - | [content/world.ts:83](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L83) |
| <a id="property-territoryfeatures"></a> `territoryFeatures?` | readonly [`TerritoryFeature`](TerritoryFeature.md)[] | - | - | [content/world.ts:84](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L84) |
| <a id="property-buildrequirements"></a> `buildRequirements?` | readonly [`EquipmentRef`](../type-aliases/EquipmentRef.md)[] | - | - | [content/world.ts:85](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L85) |
...
| <a id="property-kind"></a> `kind` | `"fortress"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
