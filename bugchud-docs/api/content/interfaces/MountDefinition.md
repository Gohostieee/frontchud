...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / MountDefinition

# Interface: MountDefinition

Defined in: [content/inventory.ts:124](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L124)

Mount definition for living transport distinct from mechanized vehicles.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"mount"`\>
...
| <a id="property-id"></a> `id` | [`MountId`](../../foundation/type-aliases/MountId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/inventory.ts:125](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L125) |
| <a id="property-movement"></a> `movement` | [`MovementProfile`](MovementProfile.md) | - | - | [content/inventory.ts:126](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L126) |
| <a id="property-combatprofile"></a> `combatProfile` | `object` | - | - | [content/inventory.ts:127](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L127) |
| `combatProfile.initiative` | `number` | - | - | [content/inventory.ts:128](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L128) |
| `combatProfile.soak` | `number` | - | - | [content/inventory.ts:129](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L129) |
| `combatProfile.hitPoints` | `number` | - | - | [content/inventory.ts:130](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L130) |
| <a id="property-carryingcapacity"></a> `carryingCapacity` | `number` | - | - | [content/inventory.ts:132](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L132) |
| <a id="property-temperamenttags"></a> `temperamentTags?` | readonly `string`[] | - | - | [content/inventory.ts:133](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L133) |
...
| <a id="property-kind"></a> `kind` | `"mount"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
