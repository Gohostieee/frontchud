...
Defined in: [content/supernatural.ts:76](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L76)
...
| <a id="property-id"></a> `id` | [`PatronId`](../../foundation/type-aliases/PatronId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/supernatural.ts:77](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L77) |
| <a id="property-pantheonref"></a> `pantheonRef?` | [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"pantheon"`\> | - | - | [content/supernatural.ts:78](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L78) |
| <a id="property-titles"></a> `titles` | readonly `string`[] | - | - | [content/supernatural.ts:79](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L79) |
| <a id="property-portfoliotags"></a> `portfolioTags` | readonly `string`[] | - | - | [content/supernatural.ts:80](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L80) |
| <a id="property-boonrefs"></a> `boonRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"boon"`\>[] | - | - | [content/supernatural.ts:81](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L81) |
| <a id="property-covenantrefs"></a> `covenantRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"covenant"`\>[] | - | - | [content/supernatural.ts:82](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L82) |
| <a id="property-relicrefs"></a> `relicRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"relic"`\>[] | - | - | [content/supernatural.ts:83](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L83) |
...
| <a id="property-kind"></a> `kind` | `"patron"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
