...
Defined in: [content/character.ts:22](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L22)
...
| ------ | ------ | ------ | ------ | ------ |
| <a id="property-id"></a> `id` | [`RaceId`](../../foundation/type-aliases/RaceId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/character.ts:23](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L23) |
| <a id="property-size"></a> `size` | `"medium"` \| `"small"` | - | - | [content/character.ts:24](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L24) |
| <a id="property-baseattributes"></a> `baseAttributes` | `Partial`\<`Record`\<[`AttributeKey`](../../foundation/type-aliases/AttributeKey.md), `number`\>\> | - | - | [content/character.ts:25](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L25) |
| <a id="property-attributegeneration"></a> `attributeGeneration` | `object` | - | - | [content/character.ts:26](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L26) |
| `attributeGeneration.method` | `"rolled"` \| `"array"` \| `"choice"` | - | - | [content/character.ts:27](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L27) |
| `attributeGeneration.notes?` | readonly `string`[] | - | - | [content/character.ts:28](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L28) |
| <a id="property-racialtraits"></a> `racialTraits` | readonly `string`[] | - | - | [content/character.ts:30](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L30) |
| <a id="property-startinglanguages"></a> `startingLanguages` | readonly `string`[] | - | - | [content/character.ts:31](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L31) |
| <a id="property-startinggrants"></a> `startingGrants?` | readonly [`GrantedCapability`](../type-aliases/GrantedCapability.md)[] | - | - | [content/character.ts:32](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/character.ts#L32) |
...
| <a id="property-kind"></a> `kind` | `"race"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
