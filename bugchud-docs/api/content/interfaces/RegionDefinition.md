...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / RegionDefinition

# Interface: RegionDefinition

Defined in: [content/world.ts:28](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L28)

Geographic region entry for campaigns and world-state context.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"region"`\>
...
| <a id="property-id"></a> `id` | [`RegionId`](../../foundation/type-aliases/RegionId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/world.ts:29](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L29) |
| <a id="property-terraintags"></a> `terrainTags` | readonly `string`[] | - | - | [content/world.ts:30](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L30) |
| <a id="property-controllingfactionrefs"></a> `controllingFactionRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"faction"`\>[] | - | - | [content/world.ts:31](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/world.ts#L31) |
...
| <a id="property-kind"></a> `kind` | `"region"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
