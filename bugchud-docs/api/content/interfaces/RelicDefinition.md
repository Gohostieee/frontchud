...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / RelicDefinition

# Interface: RelicDefinition

Defined in: [content/supernatural.ts:104](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L104)

Relic definition for sacred equipment or portable divine power sources.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"relic"`\>
...
| <a id="property-id"></a> `id` | [`RelicId`](../../foundation/type-aliases/RelicId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/supernatural.ts:105](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L105) |
| <a id="property-patronref"></a> `patronRef?` | [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"patron"`\> | - | - | [content/supernatural.ts:106](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L106) |
| <a id="property-powers"></a> `powers` | readonly [`GrantedCapability`](../type-aliases/GrantedCapability.md)[] | - | - | [content/supernatural.ts:107](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L107) |
| <a id="property-equipslot"></a> `equipSlot?` | `string` | - | - | [content/supernatural.ts:108](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L108) |
| <a id="property-linkeditemref"></a> `linkedItemRef?` | [`EquipmentRef`](../type-aliases/EquipmentRef.md) | - | - | [content/supernatural.ts:109](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/supernatural.ts#L109) |
...
| <a id="property-kind"></a> `kind` | `"relic"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
