...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / ShieldDefinition

# Interface: ShieldDefinition

Defined in: [content/inventory.ts:93](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L93)

Shield definition separated from armor because its behavior is often reactive.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"shield"`\>.`Omit`\<[`CarriedItemDefinitionShape`](CarriedItemDefinitionShape.md), `"itemKind"`\>
...
| <a id="property-id"></a> `id` | [`ShieldId`](../../foundation/type-aliases/ShieldId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/inventory.ts:96](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L96) |
| <a id="property-itemkind"></a> `itemKind` | `"shield"` | - | - | [content/inventory.ts:97](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L97) |
| <a id="property-mitigation"></a> `mitigation` | [`ShieldMitigationProfile`](ShieldMitigationProfile.md) | - | - | [content/inventory.ts:98](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L98) |
...
| <a id="property-kind"></a> `kind` | `"shield"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
