...
Defined in: [content/inventory.ts:109](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L109)
...
| <a id="property-id"></a> `id` | [`VehicleId`](../../foundation/type-aliases/VehicleId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/inventory.ts:110](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L110) |
| <a id="property-size"></a> `size` | `"medium"` \| `"small"` \| `"large"` \| `"huge"` | - | - | [content/inventory.ts:111](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L111) |
| <a id="property-chassis"></a> `chassis` | `number` | - | - | [content/inventory.ts:112](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L112) |
| <a id="property-fuelcapacity"></a> `fuelCapacity` | `number` | - | - | [content/inventory.ts:113](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L113) |
| <a id="property-gasmileage"></a> `gasMileage` | `number` | - | - | [content/inventory.ts:114](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L114) |
| <a id="property-occupants"></a> `occupants` | `number` | - | - | [content/inventory.ts:115](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L115) |
| <a id="property-cargoslots"></a> `cargoSlots` | `number` | - | - | [content/inventory.ts:116](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L116) |
| <a id="property-hardpoints"></a> `hardpoints` | readonly [`VehicleWeaponMount`](VehicleWeaponMount.md)[] | - | - | [content/inventory.ts:117](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L117) |
| <a id="property-movement"></a> `movement` | [`MovementProfile`](MovementProfile.md) | - | - | [content/inventory.ts:118](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L118) |
| <a id="property-economy"></a> `economy` | [`ItemEconomyProfile`](ItemEconomyProfile.md) | - | - | [content/inventory.ts:119](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L119) |
| <a id="property-defaultweaponrefs"></a> `defaultWeaponRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"weapon"`\>[] | - | - | [content/inventory.ts:120](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L120) |
...
| <a id="property-kind"></a> `kind` | `"vehicle"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
