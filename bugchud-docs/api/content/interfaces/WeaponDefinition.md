...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / WeaponDefinition

# Interface: WeaponDefinition

Defined in: [content/inventory.ts:69](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L69)

Weapon definition used by characters, creatures, vehicles, and warbands alike.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"weapon"`\>.`Omit`\<[`CarriedItemDefinitionShape`](CarriedItemDefinitionShape.md), `"itemKind"`\>
...
| <a id="property-id"></a> `id` | [`WeaponId`](../../foundation/type-aliases/WeaponId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/inventory.ts:72](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L72) |
| <a id="property-itemkind"></a> `itemKind` | `"weapon"` | - | - | [content/inventory.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L73) |
| <a id="property-mode"></a> `mode` | \| `"melee"` \| `"thrown"` \| `"pistol"` \| `"rifle"` \| `"heavy"` \| `"vehicleMounted"` \| `"grenade"` | - | - | [content/inventory.ts:74](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L74) |
| <a id="property-handedness"></a> `handedness` | `"mounted"` \| `"oneHanded"` \| `"twoHanded"` | - | - | [content/inventory.ts:75](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L75) |
| <a id="property-attacks"></a> `attacks` | readonly [`AttackProfileTemplate`](AttackProfileTemplate.md)[] | - | - | [content/inventory.ts:76](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L76) |
| <a id="property-ammo"></a> `ammo?` | [`WeaponAmmoProfile`](WeaponAmmoProfile.md) | - | - | [content/inventory.ts:77](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L77) |
| <a id="property-mountableonvehicles"></a> `mountableOnVehicles?` | `boolean` | - | - | [content/inventory.ts:78](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L78) |
| <a id="property-mountableonbionics"></a> `mountableOnBionics?` | readonly ( \| `"head"` \| `"eyes"` \| `"arms"` \| `"hands"` \| `"torso"` \| `"spine"` \| `"legs"` \| `"skin"` \| `"internal"` \| `"neural"`)[] | - | - | [content/inventory.ts:79](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/content/inventory.ts#L79) |
...
| <a id="property-kind"></a> `kind` | `"weapon"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/foundation/meta.ts#L73) |
