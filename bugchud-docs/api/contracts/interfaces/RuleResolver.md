...
Defined in: [contracts/resolvers.ts:17](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/contracts/resolvers.ts#L17)
...
| ------ | ------ | ------ |
| <a id="property-supports"></a> `supports` | readonly `Action`\[`"kind"`\][] | [contracts/resolvers.ts:18](https://github.com/Gohostieee/finalchud/blob/85a148e8fcb68c528fff24f9dc2939a747ac1005/src/bugchud/contracts/resolvers.ts#L18) |
