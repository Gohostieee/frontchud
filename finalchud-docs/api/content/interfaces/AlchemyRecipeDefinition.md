...
Defined in: [content/supernatural.ts:58](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L58)
...
| <a id="property-id"></a> `id` | [`AlchemyRecipeId`](../../foundation/type-aliases/AlchemyRecipeId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/supernatural.ts:59](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L59) |
| <a id="property-recipekind"></a> `recipeKind` | `"potion"` \| `"powder"` \| `"salve"` \| `"toxin"` \| `"bomb"` | - | - | [content/supernatural.ts:60](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L60) |
| <a id="property-delivery"></a> `delivery` | `"thrown"` \| `"ingested"` \| `"inhaled"` \| `"injected"` \| `"applied"` \| `"trap"` | - | - | [content/supernatural.ts:61](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L61) |
| <a id="property-potency"></a> `potency` | [`PotionPotencyProfile`](PotionPotencyProfile.md) | - | - | [content/supernatural.ts:62](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L62) |
| <a id="property-brewtime"></a> `brewTime` | `string` | - | - | [content/supernatural.ts:63](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L63) |
| <a id="property-ingredients"></a> `ingredients` | readonly [`CraftingIngredient`](CraftingIngredient.md)[] | - | - | [content/supernatural.ts:64](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L64) |
| <a id="property-effects"></a> `effects?` | readonly [`ActiveEffect`](../../foundation/interfaces/ActiveEffect.md)[] | - | - | [content/supernatural.ts:65](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L65) |
...
| <a id="property-kind"></a> `kind` | `"alchemyRecipe"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
