...
Defined in: [content/character.ts:45](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L45)
...
| ------ | ------ | ------ | ------ |
| <a id="property-origingroups"></a> `originGroups` | readonly (`"pseudoCivilized"` \| `"barbaric"` \| `"darklands"`)[] | - | [content/character.ts:46](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L46) |
| <a id="property-narrativerole"></a> `narrativeRole` | `string` | - | [content/character.ts:47](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L47) |
| <a id="property-startingdreamrefs"></a> `startingDreamRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"dream"`\>[] | - | [content/character.ts:48](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L48) |
| <a id="property-startingpackages"></a> `startingPackages` | readonly [`OwnershipGrant`](OwnershipGrant.md)[] | - | [content/character.ts:49](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L49) |
| <a id="property-socialtags"></a> `socialTags?` | readonly `string`[] | - | [content/character.ts:50](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L50) |
...
| <a id="property-kind"></a> `kind` | `"background"` | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
| <a id="property-id"></a> `id` | [`BackgroundId`](../../foundation/type-aliases/BackgroundId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | [foundation/meta.ts:74](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L74) |
