...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / CultureDefinition

# Interface: CultureDefinition

Defined in: [content/world.ts:35](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L35)

Culture entry used for language, lore, and social identity.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"culture"`\>
...
| <a id="property-id"></a> `id` | [`CultureId`](../../foundation/type-aliases/CultureId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/world.ts:36](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L36) |
| <a id="property-regionrefs"></a> `regionRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"region"`\>[] | - | - | [content/world.ts:37](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L37) |
| <a id="property-languagetags"></a> `languageTags` | readonly `string`[] | - | - | [content/world.ts:38](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L38) |
| <a id="property-socialtags"></a> `socialTags?` | readonly `string`[] | - | - | [content/world.ts:39](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L39) |
...
| <a id="property-kind"></a> `kind` | `"culture"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
