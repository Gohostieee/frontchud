...
Defined in: [content/character.ts:36](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L36)
...
| ------ | ------ | ------ | ------ |
| <a id="property-group"></a> `group` | `"pseudoCivilized"` \| `"barbaric"` \| `"darklands"` | - | [content/character.ts:37](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L37) |
| <a id="property-startingdreamrefs"></a> `startingDreamRefs?` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"dream"`\>[] | - | [content/character.ts:38](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L38) |
| <a id="property-availablebackgroundrefs"></a> `availableBackgroundRefs` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"background"`\>[] | - | [content/character.ts:39](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L39) |
| <a id="property-homelandtags"></a> `homelandTags` | readonly `string`[] | - | [content/character.ts:40](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L40) |
| <a id="property-startinglanguages"></a> `startingLanguages?` | readonly `string`[] | - | [content/character.ts:41](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/character.ts#L41) |
...
| <a id="property-kind"></a> `kind` | `"origin"` | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
| <a id="property-id"></a> `id` | [`OriginId`](../../foundation/type-aliases/OriginId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | [foundation/meta.ts:74](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L74) |
