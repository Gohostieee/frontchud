...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / PantheonDefinition

# Interface: PantheonDefinition

Defined in: [content/supernatural.ts:69](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L69)

Pantheon groups patrons into a larger religious family.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"pantheon"`\>
...
| <a id="property-id"></a> `id` | [`PantheonId`](../../foundation/type-aliases/PantheonId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/supernatural.ts:70](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L70) |
| <a id="property-patronrefs"></a> `patronRefs` | readonly [`RegistryRef`](../../foundation/interfaces/RegistryRef.md)\<`"patron"`\>[] | - | - | [content/supernatural.ts:71](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L71) |
| <a id="property-doctrine"></a> `doctrine` | readonly `string`[] | - | - | [content/supernatural.ts:72](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/supernatural.ts#L72) |
...
| <a id="property-kind"></a> `kind` | `"pantheon"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
