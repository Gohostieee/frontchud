...
[@bugchud/core API Reference](../../index.md) / [content](../index.md) / TerminologyDefinition

# Interface: TerminologyDefinition

Defined in: [content/world.ts:43](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L43)

Glossary or setting terminology entry from the world chapter.
...
- [`BaseTaggedDefinition`](BaseTaggedDefinition.md)\<`"terminology"`\>
...
| <a id="property-id"></a> `id` | [`TerminologyId`](../../foundation/type-aliases/TerminologyId.md) | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`id`](BaseTaggedDefinition.md#property-id) | - | [content/world.ts:44](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L44) |
| <a id="property-term"></a> `term` | `string` | - | - | [content/world.ts:45](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L45) |
| <a id="property-category"></a> `category` | `"faction"` \| `"timekeeping"` \| `"creatureType"` \| `"slang"` \| `"religion"` | - | - | [content/world.ts:46](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/content/world.ts#L46) |
...
| <a id="property-kind"></a> `kind` | `"terminology"` | - | [`BaseTaggedDefinition`](BaseTaggedDefinition.md).[`kind`](BaseTaggedDefinition.md#property-kind) | [foundation/meta.ts:73](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/foundation/meta.ts#L73) |
