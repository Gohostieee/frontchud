...
[@bugchud/core API Reference](../../index.md) / [contracts](../index.md) / AdvanceTurnAction

# Interface: AdvanceTurnAction

Defined in: [contracts/actions.ts:257](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/contracts/actions.ts#L257)

Step encounter turn state forward.
...
| <a id="property-kind"></a> `kind` | `"advanceTurn"` | [`BaseGameAction`](BaseGameAction.md).[`kind`](BaseGameAction.md#property-kind) | - | [contracts/actions.ts:258](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/contracts/actions.ts#L258) |
| <a id="property-actor"></a> `actor?` | [`EntityRef`](../../foundation/interfaces/EntityRef.md)\<`"encounter"`\> | [`BaseGameAction`](BaseGameAction.md).[`actor`](BaseGameAction.md#property-actor) | - | [contracts/actions.ts:259](https://github.com/Gohostieee/finalchud/blob/aa9d2548e961dbc773e77737086a0a1e2c64eb3f/src/bugchud/contracts/actions.ts#L259) |
